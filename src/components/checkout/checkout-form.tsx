...
export function CheckoutForm({
  ...
  const form = useForm<Values>({
    ...
    defaultValues: { name: "", email: defaultEmail, phone: "", couponCode: "" },
  });
  async function submit(values: Values) {
    ...
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Checkout শুরু করা যায়নি",
      );
      setLoading(false);
    }
  }
  return (
    <form onSubmit={form.handleSubmit(submit)} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Input id="coupon" {...form.register("couponCode")} />
      </div>
